        ...
        <nav id="sidebarMenu" class="d-md-flex sidebar collapse">
          <div class="position-sticky pt-3">
            ...
            <ul class="nav flex-column">
              <li class="nav-item">
                <a id="home-link" href="{{Route('index')}}" class="nav-link active" aria-current="page" title="الصفحة الرئيسية">
                ...
                <li class="nav-item">
                    <a id="customers-link" class="nav-link " href="{{Route('index4')}}" title="الزبائن">
